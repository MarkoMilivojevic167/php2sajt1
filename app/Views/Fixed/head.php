...
<html itemscope="" itemtype="http://schema.org/WebPage" lang="en">
    <head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-158263077-1"></script>
        <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-158263077-1');
        </script>


        <title>MARCO RESTAURANT | FOOD, DESSERT, DRINK</title><!-- 35-65 characters-->
        <meta charset="UTF-8">
        ...
        <link rel="icon" href="app/Assets/Images/icon.ico">

        <link rel=”canonical” href=http://marco-restaurant.epizy.com//index.php />
        ...
        <meta property="og:image" content="http://marco-restaurant.epizy.com/app/Assets/Images/bg1.jpg">
        <meta property="og:locale" content="sr-RS">
        <meta property="og:country-name" content="rs">
        <!-- og-->
        <meta itemprop="name" content="MARCO RESTAURANT">
        <meta itemprop="image" content="http://marco-restaurant.epizy.com/app/Assets/Images/bg1.jpg">
        ...
        <meta name="twitter:image" content="http://marco-restaurant.epizy.com/app/Assets/Images/bg1.jpg">
        <!--twitter-->
